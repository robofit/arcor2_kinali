...
class RobotApi(object):
    ...
    def pose_put(self, **kwargs):  # noqa: E501
        """Moves robot's end-effector to specific pose.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pose_put(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.pose_put_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.pose_put_with_http_info(**kwargs)  # noqa: E501
            return data

    def pose_put_with_http_info(self, **kwargs):  # noqa: E501
        """Moves robot's end-effector to specific pose.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pose_put_with_http_info(async_req=True)
        >>> result = thread.get()
